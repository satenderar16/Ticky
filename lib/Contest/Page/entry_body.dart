...
class __EntryBodyState extends ConsumerState<EntryBodyList> {
    ...
    return StyledContainer(
      child: Column(
        children: [
          ...
          buildInstructionList(instructionString), // let be as it is:
          Padding(
        ...
        children: [
          ...
          CustomGrid(
            ...
            children: [
              DataLabelCard(
                label: 'Questions',
                data: contestDetails.questionCount.toString(),
              ),
              DataLabelCard(
                label: 'Duration',
          ...
          Text(
            contestDetails.instruction ?? 'No intructions',
  ...
  // TODO using in General instruction of application:
