                      ...
                      IntrinsicHeight(
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                'Please submit before ${_formatTime(widget.submitBefore)}',
                              ),
                            ),
                          ],
                        ),
...
class BottomSubmitNavbar extends StatefulWidget {
  final Future<String> Function() onSubmit; // async callback
        ...
        Flexible(
          child: Consumer(
            builder: (context, ref, child) {
              final source = ref.read(currentContestProvider).source;
              if (source == null) {
                return SizedBox.shrink();
              }
              final navigateTo = switch (source) {
                ContestSource.live => ContestPage(),
                ContestSource.participates => ParticipatedPage(),
              };
              return AsyncActionBottomBar(
...
class QuestionSummary extends StatelessWidget {
  ...
  String _formatDuration(Duration d) {
    ...
    final roundedSeconds = double.parse(seconds.toStringAsFixed(2));
