...
class RegisterDetailModel {
  ...
  final AsyncValue<RResultModel?> resultModel; // only for the logged in user:
  ...
  RegisterDetailModel({
    ...
    this.resultModel = const AsyncData(null),
  });
  // using the contests for now :
  factory RegisterDetailModel.fromJson(Map<String, dynamic> json) {
    try {
      return RegisterDetailModel(contest: ContestDetailModel.fromJson(json));
    } catch (e) {
  ...
  RegisterDetailModel copyWith({
    ContestDetailModel? contest,
    List<LeaderboardModel>? leaderboard,
    bool? leaderboardHasNext,
    AsyncValue<RResultModel?>? resultModel,
  }) {
...
class RResultModel {
  ...
  final int rank; // nn
  final List<RResultQuestionModel> questions; // nn
  ...
  factory RResultModel.fromJson(Map<String, dynamic> json) {
    try {
      return RResultModel(
        ...
        questions:
            (json['questions'] as List)
                .map((e) => RResultQuestionModel.fromJson(e))
                .toList(),
      );
    } catch (e) {
...
class RResultQuestionModel {
  ...
  factory RResultQuestionModel.fromJson(Map<String, dynamic> json) {
    try {
      return RResultQuestionModel(
